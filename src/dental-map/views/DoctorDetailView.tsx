              ...
              <div className="flex items-center justify-center gap-2" aria-label="Sharh navigatsiyasi">
                ...
                {reviews.map((review, index) => (
                  <button
                    ...
                    className={cn(
                      "h-2 rounded-pill transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 focus-visible:ring-offset-surface-0",
