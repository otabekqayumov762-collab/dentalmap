  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      >
        ...
        {error && (
          <div role="alert" className="flex items-center gap-2 rounded-card bg-danger/10 px-3 py-2.5 text-danger">
      ...
      {sent && (
        <div className="flex items-center gap-3 rounded-card bg-success/10 p-4 text-success shadow-card">
          <span className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-pill bg-success/15">
