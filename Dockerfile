...
ARG NEXT_PUBLIC_MINI_APP_DIRECT_LINK
ENV NEXT_PUBLIC_MINI_APP_DIRECT_LINK=${NEXT_PUBLIC_MINI_APP_DIRECT_LINK}
...
ARG NEXT_PUBLIC_RECEIPT_ORIGINS
ENV NEXT_PUBLIC_RECEIPT_ORIGINS=${NEXT_PUBLIC_RECEIPT_ORIGINS}
...
ARG NEXT_PUBLIC_LEGAL_TAX_ID
ENV NEXT_PUBLIC_LEGAL_TAX_ID=${NEXT_PUBLIC_LEGAL_TAX_ID}
ARG NEXT_PUBLIC_LEGAL_ADDRESS
ENV NEXT_PUBLIC_LEGAL_ADDRESS=${NEXT_PUBLIC_LEGAL_ADDRESS}
ARG NEXT_PUBLIC_LEGAL_PHONE
ENV NEXT_PUBLIC_LEGAL_PHONE=${NEXT_PUBLIC_LEGAL_PHONE}
ARG NEXT_PUBLIC_SUBSCRIPTION_PRICE
ENV NEXT_PUBLIC_SUBSCRIPTION_PRICE=${NEXT_PUBLIC_SUBSCRIPTION_PRICE}
ARG NEXT_PUBLIC_OTP_ENABLED
ENV NEXT_PUBLIC_OTP_ENABLED=${NEXT_PUBLIC_OTP_ENABLED}
